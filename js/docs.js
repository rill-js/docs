...
export default {
  '/': fs.readFileSync(path.join(path.join(__dirname, '../node_modules/rill'), 'README.md'), 'utf8'),
  '/app': fs.readFileSync(path.join(path.join(__dirname, '../node_modules/rill/docs/api/'), 'index.md'), 'utf8'),
